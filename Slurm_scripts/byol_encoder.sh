#!/bin/bash
#SBATCH --job-name=byol_encoder
#SBATCH --account=def-pfieguth
#SBATCH --time=7:00:00
#SBATCH --mem-per-cpu=10G
#SBATCH --gpus=nvidia_h100_80gb_hbm3_2g.20gb:1
#SBATCH --output=slurm_output/byol_encoder.out
#SBATCH --error=slurm_output/byol_encoder.err
...
--exp-name "${EXP_NAME}" \
--save-pretrained-encoder "byol_${DATASET}_e${SSL_EPOCHS}_s${SEED}" \
