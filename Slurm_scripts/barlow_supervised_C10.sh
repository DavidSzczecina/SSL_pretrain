#!/bin/bash
#SBATCH --job-name=C10_barlow_supervised_s1-2
#SBATCH --account=def-pfieguth
#SBATCH --time=36:00:00
#SBATCH --mem-per-cpu=4G
#SBATCH --gpus=a100_1g.5gb:1
#SBATCH --output=slurm_output/C10_barlow_supervised_s1-2.out
#SBATCH --error=slurm_output/C10_barlow_supervised_s1-2.err
