#!/bin/bash
#SBATCH --job-name=SimCLR_encoder_c100
#SBATCH --account=def-pfieguth
#SBATCH --time=7:00:00
#SBATCH --mem-per-cpu=10G
#SBATCH --gpus=nvidia_h100_80gb_hbm3_2g.20gb:1
#SBATCH --output=slurm_output/SimCLR_encoder_c100.out
#SBATCH --error=slurm_output/SimCLR_encoder_c100.err
...
for SEED in "${SEEDS[@]}"; do
    ...
    --exp-name "${EXP_NAME}" \
    --save-pretrained-encoder "simclr_${DATASET}_e${SSL_EPOCHS}_s${SEED}" \
