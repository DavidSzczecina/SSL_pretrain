#!/bin/bash
#SBATCH --job-name=Clothing1M_pretrain_barlow-e10
#SBATCH --account=def-pfieguth
#SBATCH --time=20:00:00
#SBATCH --cpus-per-task=4
#SBATCH --mem-per-cpu=2000M
#SBATCH --gpus=a100_3g.20gb:1
#SBATCH --output=slurm_output_C1M/Clothing1M_pretrain_barlow-e10_%j.out
#SBATCH --error=slurm_output_C1M/Clothing1M_pretrain_barlow-e10_%j.err
...
for SEED in "${SEEDS[@]}"; do
    EXP_NAME="barlow_C1M_preE-10__supE-${EPOCHS_SUP}_s-${SEED}"
