#!/bin/bash
#SBATCH --job-name=baseline_imagenet_s5
#SBATCH --account=def-pfieguth
#SBATCH --time=20:00:00
#SBATCH --mem-per-cpu=10G
#SBATCH --gpus=a100_1g.5gb:1
#SBATCH --output=slurm_output/baseline_imagenet_s5.out
#SBATCH --error=slurm_output/baseline_imagenet_s5.err
...
for SEED in "${SEEDS[@]}"; do
  for NOISE in "${NOISE_RATES[@]}"; do
    EXP_NAME="baseline-imagenet_${DATASET}_supE-${EPOCHS_SUP}_noise-${NOISE}_s-${SEED}"
